	...
	<s:form action="ReviewChangeConfirmAction">
		...
		<div class="hyouka">
			...
			<input id="hoshi1" type="radio" name="value" value="5" /> <label
				for="hoshi1">★</label> <input id="hoshi2" type="radio" name="value"
				value="4" /> <label for="hoshi2">★</label> <input id="hoshi3"
				type="radio" name="value" value="3" /> <label for="hoshi3">★</label>
			<input id="hoshi4" type="radio" name="value" value="2" /> <label
				for="hoshi4">★</label> <input id="hoshi5" type="radio" name="value"
				value="1" /> <label for="hoshi5">★</label> <input type="radio"
				name="value" value="" checked="checked" style="display: none;" />
		</div>
	レビュー:
