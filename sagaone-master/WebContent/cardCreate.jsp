		...
		<table>
				...
				<p class ="error">
					...
					<tr>
						...
						<td>
							<input type="text" name="securityNumber" placeholder="3～4桁,数字" <s:if test="session != null"> value="<s:property value="securityNumber"/>"</s:if> size="35">
						</td>
						<td>
								<p class="error">
