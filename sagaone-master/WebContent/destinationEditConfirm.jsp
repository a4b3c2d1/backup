...
<body>
	...
	<div id="main" class="wrapper">
		<s:form action="DestinationEditCompleteAction" theme="simple">
			<table class="t-body">
				<tr class="input-area">
					<td class="topic">姓</td>
			...
			<div class="sub-btn">
				<s:submit class="btn l-btn" value="変更する" />
				<input class="btn l-btn" type="button" onclick="location.href='<s:url action="DestinationEditAction" />' "value="修正する">
			</div>
		</s:form>
	</div>
