	...
	<s:iterator value="#session.itemdetailDTOList">
		<s:form action="CartAction">
			<tr>
				...
				<td><input type="submit" value="カートに入れる" onClick="alert('カートにいれました！');"><td>
			</tr>
		</s:form>
	</s:iterator>
	...
	<s:iterator value="#session.itemdetailDTOList">
		<s:form action="ReviewAction">
			<tr>
				...
				<s:submit value="レビューを書く"></s:submit>
			</tr>
		</s:form>
	</s:iterator>
		...
		<s:form action="ItemDetailAction">
			<tr>
				...
				<td><input type="hidden" name="category_id"
					value="<s:property value='category_id' />"></input></td>
				<td><input type="image"
					src="<s:property value="image_file_path"/>" width=auto height="100" /></td>
			</tr>
		</s:form>
	</s:iterator>
	<p>
